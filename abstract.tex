...
The key of our approach is to utilize compact, \chireplace{solid}{sturdy} and re-usable internal structure (Zometool) to \chinky{infill fabrications and} replace \chireplace{the}{} both time and material-consuming 3D-printed materials.
\chireplace{And}{ Moreover, }as a result, we can \chireplace{greatly}{significantly} reduce the cost and time by printing \chireplace{a}{} thin 3D external shells only.
