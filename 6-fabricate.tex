...
However, it sometimes generate\chinky{s} the surface with flipped triangles that stick out of the outer surface (\figname~\ref{fig:shrink_mesh} (b)).
...
\caption{
\ichao{Please remove the upper figure...}
