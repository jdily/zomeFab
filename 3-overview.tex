...
\caption{
\ichao{Remove chapter in the figure..}
\ichao{Replace ``input zometool construction'' to ``inner zometool construction''}
\ichao{Fabrication things!? Please change it to Fabrication.}
